...
- create a post : POST site.com/posts   -  title: robin, description: this is a new post

- leave two comments on the post : POST site.com/posts/4/comments   text: this is a new comment 1

- edit the post
A form for editing a specific post : GET site.com/posts/4/edit
Submit the edit of an existing post : POST /posts/4    -  title: robin, description: this is a new post

- delete one of the comments on the post : POST /comments/4/delete  - comment ids are continously incrementing among all posts so you dont need to go to a specific post
